...
class Instrument:
    ...
    def __init__(self, visa_instrument_handle, vxi11_handle=None):
        ...
        self.INSTR_ID = (
            self.query(self.COMMAND_ID)
            if self.vxi11_handle is None
            else self.vxi11_handle.ask(self.COMMAND_ID)
        )
    ...
    def write(self, command_string):
        ...
        self.instrument_handle.write(
            command_string
        ) if self.vxi11_handle is None else self.vxi11_handle.write(command_string)
    ...
    def query(self, command_string):
        ...
        return (
            ...
            if self.vxi11_handle is None
            else self.vxi11_handle.ask(command_string)
        )
    ...
    def read(self):
        ...
        return (
            self.instrument_handle.read() if self.vxi11_handle is None else self.vxi11_handle.read()
        )
    ...
    def read_raw(self):
        ...
        return (
            self.instrument_handle.read_raw()
            if self.vxi11_handle is None
            else self.vxi11_handle.read_raw()
        )
